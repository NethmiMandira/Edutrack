...
export default function StudentRegistration() {
  ...
  return (
    <div className="student-registration-scroll h-screen bg-slate-50 flex flex-col lg:flex-row font-sans text-slate-900 overflow-scroll" style={{ scrollbarGutter: "stable both-edges" }}>
      <Sidebar />
      <div
