...
export default function StudentForm({ onSave, onUpdate, selectedStudent, clearFormFlag, onClearFormHandled }) {
  ...
  return (
    <form 
      ...
      className="bg-white p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 w-full box-border animate-in fade-in zoom-in-95 duration-500"
    >
